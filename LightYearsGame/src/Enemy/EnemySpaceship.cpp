...
namespace ly
{
	...
	{//specifies that a variable's value is constant
		//virtual function which redefine the class
		//pure virtual function is a member 
		SetTeamID(2);
	}
	...
	void EnemySpaceship::OnActorBeginOverlap(Actor* other)//scope resolution operator.
	{
